...
// WithStartDateCreated sets the StartDateCreated field of the QueryFilter value.
func (qf *QueryFilter) WithStartDateCreated(startDate time.Time) {
	d := startDate.UTC()
	qf.StartCreatedDate = &d
}

// WithEndDateCreated sets the EndDateCreated field of the QueryFilter value.
